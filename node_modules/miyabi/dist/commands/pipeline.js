...
import { PipelineExecutor, parsePipeline, FULL_CYCLE_PIPELINE, QUICK_DEPLOY_PIPELINE, QUALITY_GATE_PIPELINE, AUTO_FIX_PIPELINE, } from '../pipeline/pipeline-executor.js';
// ============================================================================
// Preset Pipelines
// ============================================================================
const PRESETS = {
 ...
 */
export async function executePipeline(pipelineStr, options) {
 ...
 */
function setupEventHandlers(executor, options) {
    if (options.json)
        return;
 ...
 */
function displayPipelineInfo(pipeline, commands, options) {
...
export function registerPipelineCommand(program) {
    program
        ...
        .action(async (pipelineStr, options, command) => {
