 ...
 */
export async function sprintStart(sprintName, options = {}) {
...
async function getRepositoryInfo() {
    // Get git remote
    const { execCommandSafe } = await import('../utils/cross-platform.js');
    ...
    if (!token) {
        throw new Error('GitHub token not found. Set GITHUB_TOKEN or GH_TOKEN environment variable, or run: gh auth login');
    }
 ...
 */
async function initializeProjectStructure(projectRoot) {
