 ...
 * Issue用のディレクトリパスを取得
 */
function getIssueDir(owner, repo, issueNumber) {
 ...
 * CodeGenAgentの出力を保存
 */
export function saveCodeGenOutput(owner, repo, issueNumber, output) {
 ...
 */
export function loadCodeGenOutput(owner, repo, issueNumber) {
 ...
 * ReviewAgentの出力を保存
 */
export function saveReviewOutput(owner, repo, issueNumber, output) {
    const issueDir = getIssueDir(owner, repo, issueNumber);
    ensureDir(issueDir);
 ...
 * ReviewAgentの出力を読み込み
 */
export function loadReviewOutput(owner, repo, issueNumber) {
 ...
 * Issue用のストレージをクリア
 */
export function clearIssueStorage(owner, repo, issueNumber) {
    const issueDir = getIssueDir(owner, repo, issueNumber);
 ...
 * ストレージの状態を確認
 */
export function checkIssueStorage(owner, repo, issueNumber) {
    const issueDir = getIssueDir(owner, repo, issueNumber);
