...
export async function setupLabels(owner, repo, token, options = {}) {
    ...
    for (const label of labels) {
        try {
            ...
            if (error.status === 422) {
                ...
                throw new Error(`Failed to create label "${label.name}": Permission denied. ` +
 ...
 */
async function loadLabelsFromTemplate() {
