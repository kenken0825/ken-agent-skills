 ...
 */
export async function cloneAndSetup(cloneUrl, projectName, options = {}) {
    // Clone repository
 ...
 */
async function generateSourceDirectory(projectPath, projectName) {
 ...
 */
async function generateTestDirectory(projectPath, projectName) {
 ...
 */
async function generateEnvExample(projectPath, repository) {
    // Load template
 ...
 * Generate ESLint configuration
 */
async function generateEslintConfig(projectPath) {
    // Load template
 ...
 */
async function generateReadme(projectPath, projectName, repository) {
    // Load template
