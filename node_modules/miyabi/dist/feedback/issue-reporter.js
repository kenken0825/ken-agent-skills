 ...
 */
export async function reportIssueToMiyabi(context, token) {
 ...
 */
function generateIssueTitle(context) {
 ...
 */
function generateIssueBody(context) {
 ...
 */
async function checkDuplicateIssue(octokit, context) {
    const errorType = extractErrorType(context.errorMessage);
 ...
 */
async function saveLocalFeedback(context) {
    ...
    try {
        ...
        // Write feedback
        fs.writeFileSync(feedbackFile, JSON.stringify(context, null, 2), { encoding: 'utf-8', mode: 0o600 });
 ...
 */
export function gatherEnvironmentInfo() {
 ...
 */
export function inferUserIntent(command) {
